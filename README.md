...
El token de acceso nos permitira acceder a información relacioada a los pagos (pay / location). Cada pago tiene adjunto un 'location' unico. No se implementa un endpoint para actualizar pagos o localizaciónes ya que no es un valor que se necesite modificar.
