...
* Sistema de registro de canciones, ahora podras ver cual es tu canción mejor remunerada.
* Se podra consultar los pagos obtenidos en un log. Ademas de ver la cantidad total de dinero ganado.
* Nos permitira ver graficamente nuestro crecimiento economico desde que se comenzo a utilizar la app.
...
Realizo el siguiente esquema para identificar endpoints:
